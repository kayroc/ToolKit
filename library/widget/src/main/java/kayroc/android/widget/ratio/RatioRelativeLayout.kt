...
import kayroc.android.widget.shape.layout.ShapeRelativeLayout

/**
 * 可设置宽高比的 RelativeLayout
 * @author : kayroc
 */
open class RatioRelativeLayout @JvmOverloads constructor(
    context: Context,
    attributeSet: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ShapeRelativeLayout(context, attributeSet, defStyleAttr) {
