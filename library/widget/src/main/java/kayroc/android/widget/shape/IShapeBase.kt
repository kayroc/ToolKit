...
interface IShapeBase<V: View> {
    ...
    fun initCustomAttr(context: Context, attributeSet: AttributeSet?) {
        ...
        solidPressedColor = typedArray.getColor(R.styleable.ShapeView_solidPressedColor, solidPressedColor)
        solidDisabledColor = typedArray.getColor(R.styleable.ShapeView_solidDisabledColor, solidDisabledColor)
        solidFocusedColor = typedArray.getColor(R.styleable.ShapeView_solidFocusedColor, solidFocusedColor)
        solidSelectedColor = typedArray.getColor(R.styleable.ShapeView_solidSelectedColor, solidSelectedColor)
        ...
        borderPressedColor = typedArray.getColor(R.styleable.ShapeView_borderPressedColor, borderPressedColor)
        borderDisabledColor = typedArray.getColor(R.styleable.ShapeView_borderDisabledColor, borderDisabledColor)
        borderFocusedColor = typedArray.getColor(R.styleable.ShapeView_borderFocusedColor, borderFocusedColor)
        borderSelectedColor = typedArray.getColor(R.styleable.ShapeView_borderSelectedColor, borderSelectedColor)

        borderNormalWidth = typedArray.getColor(R.styleable.ShapeView_borderNormalWidth, borderNormalWidth)
        borderPressedWidth = typedArray.getColor(R.styleable.ShapeView_borderPressedWidth, borderPressedWidth)
        borderDisabledWidth = typedArray.getColor(R.styleable.ShapeView_borderDisabledWidth, borderDisabledWidth)
        borderFocusedWidth = typedArray.getColor(R.styleable.ShapeView_borderFocusedWidth, borderFocusedWidth)
        borderSelectedWidth = typedArray.getColor(R.styleable.ShapeView_borderSelectedWidth, borderSelectedWidth)
