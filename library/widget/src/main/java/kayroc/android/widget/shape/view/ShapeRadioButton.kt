...
/**
 * 支持 xml 设置 shape 属性的 RadioButton
 * @author : kayroc
 */
class ShapeRadioButton @JvmOverloads constructor(
    ...
    override var solidCheckedColor = solidNormalColor
    ...
    override var borderCheckedColor = borderNormalColor
    ...
    override var borderCheckedWidth = borderNormalWidth
    ...
    override var textCheckedColor = textNormalColor
    ...
    override fun getShapeView(): ShapeRadioButton = this
}