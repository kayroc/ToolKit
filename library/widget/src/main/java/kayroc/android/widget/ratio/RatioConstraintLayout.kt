...
import kayroc.android.widget.shape.layout.ShapeConstraintLayout

/**
 * 可设置宽高比的 ConstraintLayout
 * @author : kayroc
 */
open class RatioConstraintLayout @JvmOverloads constructor(
    context: Context,
    attributeSet: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ShapeConstraintLayout(context, attributeSet, defStyleAttr) {
