...
public final class EncryptUtils {
    ...
    public static String encryptMD5ToHexString(
        ...
        if (salt == null) {
            return ConvertUtils.toHexString(encryptMD5(data.getBytes()));
        }
        if (data == null) {
            return ConvertUtils.toHexString(encryptMD5(salt.getBytes()));
        }
    ...
    public static String encryptMD5ToHexString(
        ...
        if (data == null) {
            return ConvertUtils.toHexString(encryptMD5(salt));
        }
        // 拼接数据
