...
public final class ColorUtils {
     ...
     */
    @SuppressWarnings({"StringConcatenationInLoop", "AlibabaStringConcat"})
    ...
    public static boolean judgeColorString(final String colorStr) {
        ...
        if (colorStr != null && colorStr.length() == 8) {
            for (int i = 0; i < colorStr.length(); i++) {
                ...
                boolean isHexColor = !(cc != '0' && cc != '1' && cc != '2' && cc != '3' && cc != '4' && cc != '5' && cc != '6' && cc != '7' && cc != '8' && cc != '9'
    ...
    public static class ColorInfo {
        ...
        private void priConvert() {
            ...
            // 获取 HSB
            float[] hsbArray = RGBtoHSB(red, green, blue, null);
            hue = hsbArray[0]; // 色调
            saturation = hsbArray[1]; // 饱和度
            brightness = hsbArray[2]; // 亮度
        }
        ...
        private static float[] RGBtoHSB(
            ...
            hsbArray[0] = hue;
            hsbArray[1] = saturation;
            hsbArray[2] = brightness;
            return hsbArray;
        }
    }
