...
public final class ValidPhoneUtils {

    private ValidPhoneUtils() {
    }
    ...
    public static boolean isPhoneCheck(final String phone) {
        return RegexUtils.match(CHAIN_PHONE_FORMAT_CHECK, phone);
    }
    ...
    public static boolean isPhone(final String phone) {
        return RegexUtils.match(CHINA_PHONE_PATTERN, phone);
    }
    ...
    public static boolean isPhoneToChinaTelecom(final String phone) {
        return RegexUtils.match(CHINA_TELECOM_PATTERN, phone);
    }
    ...
    public static boolean isPhoneToChinaUnicom(final String phone) {
        return RegexUtils.match(CHINA_UNICOM_PATTERN, phone);
    }
    ...
    public static boolean isPhoneToChinaMobile(final String phone) {
        return RegexUtils.match(CHINA_MOBILE_PATTERN, phone);
    }
    ...
    public static boolean isPhoneToHkMobile(final String phone) {
        return RegexUtils.match(HK_PHONE_PATTERN, phone);
    }
    ...
    public static boolean isPhoneCallNum(final String phone) {
        return RegexUtils.match(PHONE_CALL_PATTERN, phone);
    }
