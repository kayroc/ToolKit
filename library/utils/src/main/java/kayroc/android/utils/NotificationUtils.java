 ...
 * </pre>
 */
@SuppressWarnings({"unused", "AlibabaLowerCamelCaseVariableNaming", "deprecation"})
public final class NotificationUtils {
    ...
    public static boolean isNotificationEnabled() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            try {
                ...
                int uid = appInfo == null ? 0 : appInfo.uid;
    ...
    public static boolean isNotificationListenerEnabled(final String packageName) {
        Set<String> packageNames = NotificationManagerCompat.getEnabledListenerPackages(ToolKitUtils.getContext());
    ...
    public static PendingIntent createPendingIntent(
        ...
        try {
            return PendingIntent.getActivity(ToolKitUtils.getContext(), requestCode, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        } catch (Exception e) {
            LogUtils.e(e.getMessage());
        }
        return null;
    ...
    public static Notification createNotification(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder = new Notification.Builder(ToolKitUtils.getContext(), channelId);
        } else {
            builder = new Notification.Builder(ToolKitUtils.getContext());
        }
        // 点击通知执行 intent
