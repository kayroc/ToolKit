...
public final class ClickUtils {
    ...
    public static class ClickAssist {
        ...
        public boolean isFastDoubleClick(
            ...
            if (mLastTagId == tagId && mLastClickTime > 0 && diffTime < intervalTime) {
                LogUtils.d("isFastDoubleClick 无效点击 tagId: " + tagId + ", intervalTime: " + intervalTime);
                return true;
            }
            LogUtils.d("isFastDoubleClick 有效点击 tagId: " + tagId + ", intervalTime: " + intervalTime);
            mLastTagId = tagId;
        ...
        public boolean isFastDoubleClick(
            ...
            if (lastTime > 0 && diffTime < intervalTime) {
                LogUtils.d("isFastDoubleClick 无效点击 object: " + object + ", intervalTime: " + intervalTime);

                return true;
            }
            LogUtils.d("isFastDoubleClick 有效点击 object: " + object + ", intervalTime: " + intervalTime);
            // 保存上次点击时间
    ...
    public static final View.OnClickListener EMPTY_CLICK = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            LogUtils.d("EMPTY_CLICK viewId:" + view.getId());
        }
    };
