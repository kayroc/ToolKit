...
public final class PathUtils {
     ...
     * </pre>
     */
    @SuppressWarnings({"deprecation", "SpellCheckingInspection", "AlibabaClassNamingShouldBeCamel"})
    ...
    public static final class AppExternalPath {
        ...
        public File getAppDataDir() {
            ...
            try {
                return ToolKitUtils.getContext().getExternalCacheDir().getParentFile();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppCacheDir() {
            ...
            try {
                return ToolKitUtils.getContext().getExternalCacheDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getExternalFilesDir(final String type) {
            ...
            try {
                return ToolKitUtils.getContext().getExternalFilesDir(type);
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppObbDir() {
            ...
            try {
                return ToolKitUtils.getContext().getObbDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
    ...
    public static final class InternalPath {
        ...
        public File getAppDataDir() {
            try {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
                    return FileUtils.getFile(ToolKitUtils.getContext().getApplicationInfo().dataDir);
                }
                return ToolKitUtils.getContext().getDataDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppCacheDir() {
            try {
                return ToolKitUtils.getContext().getCacheDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppCodeCacheDir() {
            try {
                ...
                return ToolKitUtils.getContext().getCodeCacheDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppDbFile(final String name) {
            try {
                return ToolKitUtils.getContext().getDatabasePath(name);
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppFilesDir() {
            try {
                return ToolKitUtils.getContext().getFilesDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
        ...
        public File getAppNoBackupFilesDir() {
            try {
                ...
                return ToolKitUtils.getContext().getNoBackupFilesDir();
            } catch (Exception e) {
                LogUtils.e(e.getMessage());
            }
            return null;
