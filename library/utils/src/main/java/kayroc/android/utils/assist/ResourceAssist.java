package kayroc.android.utils.assist;
...
import kayroc.android.utils.AppUtils;
...
public final class ResourceAssist {
    ...
    public static Resources staticResources() {
        return staticResources(ToolKitUtils.getContext());
    }
    ...
    public static Resources.Theme staticTheme() {
        return staticTheme(ToolKitUtils.getContext());
    }
    ...
    public static ContentResolver staticContentResolver() {
        return staticContentResolver(ToolKitUtils.getContext());
    }
    ...
    public Animation getAnimation(@AnimatorRes @AnimRes final int id) {
        return getAnimation(id, ToolKitUtils.getContext());
    }
    ...
    public ParcelFileDescriptor openFileDescriptor(
        ...
        if (uri == null || TextUtils.isEmpty(mode)) {
            return null;
        }
        try {
    ...
    public String readStringFromAssets(final String fileName) {
        try {
            return new String(readBytesFromAssets(fileName), StandardCharsets.UTF_8);
        } catch (Exception e) {
            LogUtils.e(e.getMessage());
        }
        return null;
    ...
    public String readStringFromRaw(@RawRes final int resId) {
        try {
            return new String(readBytesFromRaw(resId), StandardCharsets.UTF_8);
        } catch (Exception e) {
            LogUtils.e(e.getMessage());
        }
        return null;
