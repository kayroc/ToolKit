 ...
 * @author kayroc
 */
@SuppressWarnings({"unused", "AlibabaLowerCamelCaseVariableNaming", "deprecation", "SpellCheckingInspection"})
public final class SDCardUtils {
    ...
    public static String getAllBlockSizeFormat() {
        try {
            ...
            return Formatter.formatFileSize(ToolKitUtils.getContext(), size);
        } catch (Exception e) {
            LogUtils.e(e.getMessage());
            return null;
        }
