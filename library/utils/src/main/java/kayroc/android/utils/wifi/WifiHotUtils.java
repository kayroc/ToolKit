package kayroc.android.utils.wifi;
 ...
 * </pre>
 */
@SuppressWarnings({"unused", "CommentedOutCode", "AlibabaRemoveCommentedCode", "deprecation"})
...
//					wifiConfig.allowedProtocols.set(WifiConfiguration.Protocol.WPA);
    ...
    public boolean startWifiAp(final WifiConfiguration wifiConfig) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            try {
                ...
                mWifiManager.startLocalOnlyHotspot(new WifiManager.LocalOnlyHotspotCallback() {
                    ...
                    public void onStarted(WifiManager.LocalOnlyHotspotReservation reservation) {
                        ...
                        // 打印信息
                        LogUtils.d("Android 8.0 onStarted wifiAp ssid: " + mAPWifiSSID + ", pwd: " + mAPWifiPwd);
                        // 触发回调
                    ...
                    public void onStopped() {
                        super.onStopped();
                        // 打印信息
                        LogUtils.d("Android 8.0 onStopped wifiAp");
                        // 触发回调
                        if (mWifiAPListener != null) {
                    ...
                    public void onFailed(int reason) {
                        ...
                        // 打印信息
                        LogUtils.d("Android 8.0 onFailed wifiAp, reason: " + reason);
                        // 触发回调
                        if (mWifiAPListener != null) {
            ...
            try {
                ...
                // 打印日志
                LogUtils.d("设置 Wifi 热点信息是否成功:" + setResult);
                // 跳转到便携式热点设置页面
    ...
    public boolean closeWifiAp() {
        ...
        try {
            ...
            wifiConfig.priority = 0;
            // 设置 Wifi ssid
            wifiConfig.SSID = "CloseWifiAp";
            // formatSSID(ssid,true);
            // 设置 Wifi 密码
    ...
    public int getWifiApState() {
        try {
            ...
            // 打印状态
            LogUtils.d("WifiApState: " + wifiApState);
            return wifiApState;
        } catch (Exception e) {
            LogUtils.e(e.getMessage());
        }
