 ...
 * </pre>
 */
@SuppressWarnings({"deprecation", "unused", "AlibabaLowerCamelCaseVariableNaming", "SpellCheckingInspection"})
public final class DeviceUtils {
     ...
     * @return {@code true} yes, {@code false} no
     */
    @SuppressWarnings({"RedundantIfStatement", "CommentedOutCode", "StringOperationCanBeSimplified"})
    public static boolean isEmulator() {
        ...
        boolean checkDial = intent.resolveActivity(AppUtils.getPackageManager()) == null;
        if (checkDial) {
            return true;
        }
