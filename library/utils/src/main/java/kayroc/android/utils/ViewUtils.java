...
import kayroc.android.utils.anim.AnimationUtils;
import kayroc.android.utils.image.ImageUtils;
import kayroc.java.utils.FieldUtils;
...
public final class ViewUtils {
    ...
    public static View inflate(
        ...
        try {
            return LayoutInflater.from(ToolKitUtils.getContext()).inflate(resource, root, attachToRoot);
        } catch (Exception e) {
            LogUtils.e(e.getMessage());
        }
        return null;
    ...
    public static boolean setMarginLeft(
        ...
        if (reset) {
            return setMargin(view, leftMargin, 0, 0, 0);
        }
    ...
    public static boolean setMarginTop(
        ...
        if (reset) {
            return setMargin(view, 0, topMargin, 0, 0);
        }
        int[] margin = getMargin(view);
    ...
    public static boolean setMarginRight(
        ...
        if (reset) {
            return setMargin(view, 0, 0, rightMargin, 0);
        }
        int[] margin = getMargin(view);
    ...
    public static boolean setMarginBottom(
        ...
        if (reset) {
            return setMargin(view, 0, 0, 0, bottomMargin);
        }
        int[] margin = getMargin(view);
    ...
    public static boolean setPaddingLeft(
        ...
        if (reset) {
            return setPadding(view, leftPadding, 0, 0, 0);
        }
    ...
    public static boolean setPaddingTop(
        ...
        if (reset) {
            return setPadding(view, 0, topPadding, 0, 0);
        }
        int[] padding = getPadding(view);
    ...
    public static boolean setPaddingRight(
        ...
        if (reset) {
            return setPadding(view, 0, 0, rightPadding, 0);
        }
        int[] padding = getPadding(view);
    ...
    public static boolean setPaddingBottom(
        ...
        if (reset) {
            return setPadding(view, 0, 0, 0, bottomPadding);
        }
        int[] padding = getPadding(view);
