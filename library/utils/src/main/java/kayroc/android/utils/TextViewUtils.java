 ...
 * </pre>
 */
@SuppressWarnings({"UnusedReturnValue", "unused", "unchecked", "SpellCheckingInspection"})
public final class TextViewUtils {
    ...
    public static float reckonTextSizeByWidth(
        ...
        if (width <= 0 || curTextSize <= 0 || content == null) {
            return 0f;
        }
    ...
    public static float reckonTextSizeByWidth(
        ...
        if (paint == null || width <= 0 || curTextSize <= 0 || content == null) {
            return 0f;
        }
     ...
     *     {@link kayroc.android.utils.image.ImageUtils#setBounds}
     * </pre>
     *
     * @param textView {@link TextView}
     * @param left     left Drawable
