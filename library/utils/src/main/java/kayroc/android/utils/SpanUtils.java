...
public final class SpanUtils {
    ...
    public SpanUtils appendLine() {
        apply(TYPE_CHAR_SEQUENCE);
        mText = StringUtils.NEW_LINE_STR;
        return this;
    }
    ...
    public SpanUtils appendLine(@NonNull final CharSequence text) {
        apply(TYPE_CHAR_SEQUENCE);
        mText = text + StringUtils.NEW_LINE_STR;
        return this;
    }
...
//            paint.getShader();
    ...
    /**
     * SpannableStringBuilder 内部类, 实现序列化方便传值
     *
     * @author kayroc
     */
    ...
    private static Context getContext() {
        return ToolKitUtils.getContext();
    }
}